...
export default function MyPositionsComponent({ onSuccess }: MyPositionsComponentProps) {
  ...
  const mockPositions: LoanPosition[] = [
    ...
    },
    {
      ...
      expiration: BigInt(Math.floor(Date.now() / 1000) + 15 * 24 * 60 * 60), // 15 days
    ...
    return (
      <Card className="p-6 sm:p-8 text-center" style={{
        ...
        <div className="flex flex-col items-center space-y-4">
          <PieChart className="w-12 h-12 sm:w-16 sm:h-16 text-blue-400" />
          <h3 className="text-lg sm:text-xl font-bold text-gray-700">Connect Wallet to View Positions</h3>
          <p className="text-sm sm:text-base text-gray-600">Connect your wallet to view and manage your active loans</p>
        </div>
      </Card>
    )
  }
    ...
    return (
      <Card className="p-6 sm:p-8 text-center" style={{
        ...
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-sm sm:text-base text-gray-600">Loading your positions...</p>
        </div>
      </Card>
    )
  }
      ...
      <Card className="p-4 sm:p-6" style={{
        ...
        <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 mb-4 sm:mb-6">
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-gray-600 mt-1 text-sm sm:text-base">Manage your active loans and track performance</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
          ...
          <div className="text-center p-3 sm:p-4 rounded-lg" style={{
            ...
            <p className={`text-base sm:text-lg font-bold ${portfolioStats.avgHealthFactor >= 1.2 ? 'text-green-700' :
      ...
      {positions.length === 0 ? (
        <Card className="p-6 sm:p-8 text-center" style={{
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-gray-700">No Active Positions</h3>
            <p className="text-sm sm:text-base text-gray-600">You don't have any active loans. Create a loan to start borrowing.</p>
          </div>
        </Card>
      ) : (
        positions.map((position) => (
          <Card key={position.loanId} className="p-4 sm:p-6 transition-all duration-300 hover:shadow-lg" style={{
            backgroundColor: "rgba(255, 255, 255, 0.25)",
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4 sm:mb-6 space-y-2 sm:space-y-0">
              <div className="flex-1">
                <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
                  ...
                  <span className={`px-2 py-1 text-xs font-bold rounded-full ${position.status === 'healthy' ? 'bg-green-100 text-green-800' :
              ...
              <TabsContent value="repayment" className="space-y-4">
                <div className="grid grid-cols-1 gap-4 sm:gap-6">
                  <div className="space-y-4">
                    <h4 className="font-semibold text-sm sm:text-base">Repayment Breakdown</h4>
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        <span className="text-gray-600 text-sm">Protocol Fee:</span>
                        <span className="font-semibold text-sm">
                  ...
                  <div className="space-y-4">
                    <h4 className="font-semibold text-sm sm:text-base">Your USDC Balance</h4>
                    ...
                    <Button
                      ...
                      className="w-full py-3 text-base sm:text-lg font-bold text-white"
                      style={{
                        fontFamily: "'GT Standard Mono', 'JetBrains Mono', 'Fira Code', 'SF Mono', Consolas, monospace",
                        fontWeight: "600",
                        letterSpacing: "0.05em",
